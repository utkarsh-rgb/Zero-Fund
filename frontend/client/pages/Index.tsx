        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1 text-center md:text-left">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Empowering startups to build, collaborate, and succeed without traditional funding barriers.
            </p>
            <div className="flex justify-center md:justify-start space-x-3">
              <a href="#" className="w-10 h-10 rounded-lg bg-slate-700/50 hover:bg-blue-600 flex items-center justify-center transition-all duration-300 hover:scale-110">
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-400 hover:text-white transition-colors duration-200 text-sm inline-flex items-center group">
              ...
              <li>
                <a href="#" className="text-gray-400 hover:text-white transition-colors duration-200 text-sm inline-flex items-center group">
                  <ArrowRight className="w-3 h-3 mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
                  <span className="group-hover:translate-x-1 transition-transform duration-200">Reviews</span>
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <div className="text-sm text-gray-400">
              © 2026 Zero Fund Venture. Building the future of startup collaboration.
            </div>
