        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-lg md:text-xl text-slate-600 mb-8 leading-relaxed max-w-2xl">
              Match, contract, and build — equity-first collaborations with clear roles and legal protection.
            </p>
              ...
              <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-8">
                <div className="space-y-6">
                  ...
                  <div className="text-center pb-4 border-b border-slate-200">
                    <h3 className="text-xl font-bold text-slate-900 mb-2">Collaboration Illustration</h3>
                    <p className="text-sm text-slate-500">Equity-based partnership</p>
                  </div>
                  ...
                  <div className="flex items-center justify-center gap-8">
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <span className="text-sm font-semibold text-slate-700">Entrepreneur</span>
                      <span className="text-xs text-slate-500">Idea & Vision</span>
                    </div>

                    {/* Connection Line */}
                    <div className="flex flex-col items-center">
                      <div className="w-12 h-1 bg-gradient-to-r from-blue-600 to-violet-600 rounded-full mb-2"></div>
                      <span className="text-xs font-medium text-slate-600">Equity Split</span>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <span className="text-xs text-slate-500">Skills & Build</span>
                    </div>
                  </div>
...
<div className="grid grid-cols-3 gap-4 pt-4 border-t border-slate-200">
  <div className="text-center">
    <div className="text-lg font-bold text-blue-600 py-2 ">Founder Equity</div>
    <div className="text-xs text-slate-500">  </div>
  </div>

  <div className="text-center">
    <div className="text-lg font-bold text-emerald-600">Legal</div>
    <div className="text-xs text-slate-500">Smart Contract</div>
  </div>

  <div className="text-center">
    <div className="text-lg font-bold text-violet-600">Developer Equity</div>
    <div className="text-xs text-slate-500"> </div>
  </div>
</div>
