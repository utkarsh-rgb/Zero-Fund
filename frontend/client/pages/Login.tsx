        ...
        <div className="hidden lg:flex flex-col justify-center p-6 xl:p-8 bg-gradient-to-br from-skyblue to-navy text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-blue-100 text-sm xl:text-base mb-5">
              Join our community of entrepreneurs and developers creating innovative solutions.
            </p>
            <div className="space-y-2.5">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-xs xl:text-sm">Cutting-edge Technology</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 sm:p-7 lg:p-6 xl:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-3 lg:space-y-3.5">
            ...
            <div className="text-right">
              <Link to="/forgot-password" className="text-xs lg:text-sm text-skyblue hover:underline font-medium">
                Forgot Password?
              </Link>
            </div>
          ...
          <div className="mt-4 text-center">
            <Link to="/" className="text-xs lg:text-sm text-gray-500 hover:text-gray-700 inline-flex items-center font-medium transition">
