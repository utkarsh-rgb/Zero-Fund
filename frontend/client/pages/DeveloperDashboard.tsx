...
//   const [collaborationsLoading, setCollaborationsLoading] =
...
//                   >
//                     <Lightbulb
//                       className={`w-5 h-5 transition-transform ${activeTab === "feed" ? "" : "group-hover:scale-110 group-hover:rotate-12"}`}
//                     />
...
//                   >
//                     <Bookmark
//                       className={`w-5 h-5 transition-transform ${activeTab === "bookmarks" ? "" : "group-hover:scale-110 group-hover:rotate-12"}`}
//                     />
...
//                     {collaborations.filter((c: any) => !c.signed_by_developer)
//                       .length > 0 && (
//                       <span
//                         className={`ml-auto text-xs px-2.5 py-1 rounded-full font-semibold ${
//                           activeTab === "contracts"
...
//                   >
//                     <Users
//                       className={`w-5 h-5 transition-transform ${activeTab === "collaborations" ? "" : "group-hover:scale-110"}`}
//                     />
...
//                       $
//                       {(
//                         stats?.performance?.estimatedPortfolioValue || 0
//                       ).toLocaleString()}
//                     </span>
//                   </div>
//                   <div className="flex justify-between items-center">
...
//                     Track your proposals, collaborations and discover new
//                     opportunities
//                   </p>
//                 </div>
...
//                                   onClick={() =>
//                                     navigate(
//                                       `/developer-chat?entrepreneur=${c.entrepreneur_id}`,
//                                     )
//                                   }
...
//                         <p>
//                           <strong>Entrepreneur:</strong>{" "}
//                           {selectedContract.entrepreneur_name}
//                         </p>
//                         <p>
//                           <strong>Developer:</strong>{" "}
//                           {selectedContract.developer_name}
//                         </p>
//                         <p>
//                           <strong>Timeline:</strong> {selectedContract.timeline}
//                         </p>
//                         <p>
//                           <strong>Equity:</strong>{" "}
//                           {selectedContract.equity_percentage}
//                         </p>
//                         <p>
...
//                           {selectedContract.ip_ownership}
//                         </p>
//                         <p>
//                           <strong>Confidentiality:</strong>{" "}
//                           {selectedContract.confidentiality}
//                         </p>
//                         <p>
...
//                           {selectedContract.dispute_resolution}
//                         </p>
//                         <p>
...
//                           {selectedContract.support_terms}
//                         </p>
//                         <p>
...
//                         </p>
//                         <p>
//                           <strong>Scope:</strong> {selectedContract.scope}
//                         </p>
