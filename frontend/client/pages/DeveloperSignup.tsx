      ...
      <div className="w-full max-w-2xl px-4 py-6 sm:py-12">
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-8 shadow-lg border border-gray-100">
          <div className="text-center mb-6 sm:mb-8">
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-navy to-skyblue rounded-xl flex items-center justify-center mx-auto mb-3 sm:mb-4 shadow-md">
