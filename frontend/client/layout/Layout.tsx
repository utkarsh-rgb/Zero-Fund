...
>
  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br to-navy rounded-xl flex items-center justify-center shadow-sm">
    <img
  ...
  <span className="text-base sm:text-lg md:text-xl font-bold text-navy hidden sm:inline">
    Zero Fund Venture
  </span>
</Link>
