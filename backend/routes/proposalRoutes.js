...
const {getDeveloperProposals,getEntrepreneurProposals,updateProposalStatus,getProposalById,submitProposal, manageProposal} = require("../controllers/proposalController");
